...
if __name__ == '__main__':
    ...
    parse.add_argument('--child1' , type=str, default='Proton', help='child particle 1')
    parse.add_argument('--child2' , type=str, default='Kaon', help='child particle 2')
    parse.add_argument('--child3' , type=str, default='L1', help='child particle 3')
    parse.add_argument('--child4' , type=str, default='L2', help='child11 particle 4')
    ...
    PX, PY, PZ, PE = ('_PX', '_PY', '_PZ', '_PE') # in RapidSim E is just E not PE like in dtt
